...
class BlenderScene:
    ...
    def setup_scene(self, clear_existing: bool = True) -> bpy.types.Scene:
        ...
        if self.scene_name in bpy.data.scenes:
            ...
            self.scene = bpy.data.scenes.new(self.scene_name)
    ...
    def setup_camera(self, location: Tuple[float, float, float] = (10, -10, 8),
    ...
    def setup_render_settings(self, resolution: Tuple[int, int] = (1920, 1080),
                            samples: int = 128):
    ...
    def add_trajectory_path(self, trajectory_data, name: str = "trajectory",
